...
| #   | Task                                             | Est. Time |
| --- | ------------------------------------------------ | --------- |
| 1   | Repository setup and configuration               | 4h        |
...
| 5   | Database schema design and migration framework   | 16h       |
| 6   | Authentication service integration               | 6h        |
| 7   | API framework, routing, and middleware setup     | 6h        |
| 8   | Mobile app shell (Expo/React Native) ASK         | 6h        |
...
| #   | Task                                                                                                                                     | Est. Time |
| --- | ---------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| 1   | Restaurant Onboarding System                                                                                                             | 14h       |
...
| 4   | Set menu availability hours + holiday closure schedule                                                                                   | 6h        |
| 5   | Item-level availability toggle (real-time stock)                                                                                         | 8h        |
| 6   | Set delivery radius + regular/holiday hours                                                                                              | 6h        |
| 7   | Performance analytics: top sellers, slow movers                                                                                          | 12h       |
| 8   | Customer insights: ordering behaviour, trends, retention                                                                                 | 12h       |
